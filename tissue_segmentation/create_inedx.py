...
Imgfolder = "../../NCT-CRC-HE-100K/NCT-CRC-HE-100K"
image_ = []
label_ = []
label_mapping = {
    "ADI": 0,
...
train.to_csv('./index/NCT_CRC_train.csv', encoding="utf-8-sig", mode="a")
test.to_csv('./index/NCT_CRC_test.csv', encoding="utf-8-sig", mode="a")
# print(test)